...
public class TypicalPersons {
    ...
    public static final Employee ALICE = new PersonBuilder().withName("Alice Pauline").withRole("Finance Manager")
    ...
    public static final Employee BENSON = new PersonBuilder().withName("Benson Meier").withRole("Project Manager")
    ...
    public static final Employee CARL = new PersonBuilder().withName("Carl Kurz").withRole("System Analyst")
    ...
    public static final Employee DANIEL = new PersonBuilder().withName("Daniel Meier").withRole("Account Manager")
    ...
    public static final Employee ELLE = new PersonBuilder().withName("Elle Meyer").withRole("Developer")
    ...
    public static final Employee FIONA = new PersonBuilder().withName("Fiona Kunz").withRole("Developer")
    ...
    public static final Employee GEORGE = new PersonBuilder().withName("George Best").withRole("Developer")
    ...
    // Manually added
    public static final Employee HOON = new PersonBuilder().withName("Hoon Meier").withRole("Developer")
    ...
    public static final Employee IDA = new PersonBuilder().withName("Ida Mueller").withRole("Project Manager")
    ...
    public static final Employee AMY = new PersonBuilder().withName(VALID_NAME_AMY).withRole(VALID_ROLE_AMY)
    ...
    public static final Employee BOB = new PersonBuilder().withName(VALID_NAME_BOB).withRole(VALID_ROLE_BOB)
