...
import static employeetracker.logic.commands.CommandTestUtil.*;
...
public class TypicalPersons {
    ...
    public static final Person ALICE = new PersonBuilder().withName("Alice Pauline").withRole("Finance Manager")
            .withPhone("94351253").withEmail("alice@example.com").withAddress("123, Jurong West Ave 6, #08-111")
            .withDateOfBirth("1988-09-14").withDateOfJoining("2020-02-01")
            .withTags("friends").build();
    public static final Person BENSON = new PersonBuilder().withName("Benson Meier").withRole("Project Manager")
            .withPhone("98765432").withEmail("johnd@example.com").withAddress("311, Clementi Ave 2, #02-25")
            .withDateOfBirth("1989-11-14").withDateOfJoining("2020-02-01")
            .withTags("owesMoney", "friends").build();
    public static final Person CARL = new PersonBuilder().withName("Carl Kurz").withRole("System Analyst")
    ...
    public static final Person DANIEL = new PersonBuilder().withName("Daniel Meier").withRole("Account Manager")
    ...
    public static final Person ELLE = new PersonBuilder().withName("Elle Meyer").withRole("Developer")
    ...
    public static final Person FIONA = new PersonBuilder().withName("Fiona Kunz").withRole("Developer")
    ...
    public static final Person GEORGE = new PersonBuilder().withName("George Best").withRole("Developer")
    ...
    // Manually added
    public static final Person HOON = new PersonBuilder().withName("Hoon Meier").withRole("Developer")
    ...
    public static final Person IDA = new PersonBuilder().withName("Ida Mueller").withRole("Project Manager")
    ...
    public static final Person AMY = new PersonBuilder().withName(VALID_NAME_AMY).withRole(VALID_ROLE_AMY)
            .withPhone(VALID_PHONE_AMY).withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY)
            .withDateOfBirth(VALID_DATE_OF_BIRTH_AMY).withDateOfJoining(VALID_DATE_OF_JOINING_AMY)
            .withTags(VALID_TAG_FRIEND).build();
    public static final Person BOB = new PersonBuilder().withName(VALID_NAME_BOB).withRole(VALID_ROLE_BOB)
