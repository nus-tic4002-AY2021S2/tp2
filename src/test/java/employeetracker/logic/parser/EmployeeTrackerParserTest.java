...
//import employeetracker.testutil.EmployeeUtil;
//
...
//        EditCommand command2 = new EditCommand(INDEX_FIRST_EMPLOYEE, descriptor);
...
//        assertEquals(new FindCommand(new NameContainsKeywordsPredicate(keywords, findBy)), command);
//    }
//
//    @Test
