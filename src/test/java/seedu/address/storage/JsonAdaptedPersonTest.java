...
public class JsonAdaptedPersonTest {
    ...
    private static final List<JsonAdaptedAppointment> VALID_APPOINTMENT = BENSON.getAppointment().stream()
            ...
            .collect(Collectors.toList());
    private static final List<JsonAdaptedMedicalHistory> VALID_MEDICAL = BENSON.getMedicalHistories().stream()
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(INVALID_NAME, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_TAGS, VALID_APPOINTMENT, VALID_MEDICAL);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_PHONE,
                VALID_EMAIL, VALID_ADDRESS, VALID_TAGS, VALID_APPOINTMENT, VALID_MEDICAL);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_PHONE, null, VALID_ADDRESS, VALID_TAGS, VALID_APPOINTMENT, VALID_MEDICAL);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE,
                        VALID_EMAIL, INVALID_ADDRESS, VALID_TAGS, VALID_APPOINTMENT, VALID_MEDICAL);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(VALID_NAME,
                VALID_PHONE, VALID_EMAIL, null, VALID_TAGS, VALID_APPOINTMENT, VALID_MEDICAL);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_PHONE,
                        VALID_EMAIL, VALID_ADDRESS, invalidTags, VALID_APPOINTMENT, VALID_MEDICAL);
