...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullIc_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_DATE, null, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_DESCRIPTION, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
            new JsonAdaptedPerson(VALID_NAME, VALID_DATE, VALID_NRIC, VALID_PHONE,
                    VALID_EMAIL, INVALID_ADDRESS, VALID_DESCRIPTION, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedPerson person =
            new JsonAdaptedPerson(VALID_NAME, VALID_DATE, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                    null, VALID_DESCRIPTION, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedPerson person =
            new JsonAdaptedPerson(VALID_NAME, VALID_DATE, VALID_NRIC, VALID_PHONE,
                    VALID_EMAIL, VALID_ADDRESS, INVALID_DESCRIPTION, VALID_REMARK, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
            new JsonAdaptedPerson(VALID_NAME, VALID_DATE, VALID_NRIC, VALID_PHONE, VALID_EMAIL,
                    VALID_ADDRESS, VALID_DESCRIPTION, VALID_REMARK, invalidTags);
