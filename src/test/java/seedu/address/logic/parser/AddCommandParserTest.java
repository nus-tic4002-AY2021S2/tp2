...
import static seedu.address.logic.commands.CommandTestUtil.FOLLOWUP_DESC_AMY;
import static seedu.address.logic.commands.CommandTestUtil.FOLLOWUP_DESC_BOB;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_ADDRESS_DESC;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_DATE_DESC;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_DESCRIPTION;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_EMAIL_DESC;
import static seedu.address.logic.commands.CommandTestUtil.INVALID_FOLLOWUP_DESC;
...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_BOB + DATE_DESC_BOB
                + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + DATE_DESC_BOB
                + FOLLOWUP_DESC_BOB + DATE_DESC_AMY + NRIC_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DESCRIPTION_BOB + TAG_DESC_CALLED, new AddCommand(expectedPerson));
        // multiple nrics - last nric accepted
        assertParseSuccess(parser, NAME_DESC_BOB + DATE_DESC_BOB
                + FOLLOWUP_DESC_BOB + NRIC_DESC_AMY + NRIC_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DESCRIPTION_BOB + TAG_DESC_CALLED, new AddCommand(expectedPerson));
        // multiple phones - last phone accepted
        assertParseSuccess(parser, NAME_DESC_BOB + DATE_DESC_BOB
                + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB + PHONE_DESC_AMY + PHONE_DESC_BOB + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DESCRIPTION_BOB + TAG_DESC_CALLED, new AddCommand(expectedPerson));
        // multiple emails - last email accepted
        assertParseSuccess(parser, NAME_DESC_BOB + DATE_DESC_BOB
                + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_AMY + EMAIL_DESC_BOB
                + ADDRESS_DESC_BOB + DESCRIPTION_BOB + TAG_DESC_CALLED, new AddCommand(expectedPerson));
        // multiple addresses - last address accepted
        assertParseSuccess(parser, NAME_DESC_BOB + DATE_DESC_BOB
                + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_AMY
                + ADDRESS_DESC_BOB + DESCRIPTION_BOB + TAG_DESC_CALLED, new AddCommand(expectedPerson));
        // multiple descriptions - last description accepted
        assertParseSuccess(parser, NAME_DESC_BOB + DATE_DESC_BOB
                + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + DESCRIPTION_AMY + DESCRIPTION_BOB + TAG_DESC_CALLED, new AddCommand(expectedPerson));
        // multiple tags - all accepted
        Person expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_CALLED, VALID_TAG_SEVERITY)
                .build();
        assertParseSuccess(parser, NAME_DESC_BOB + DATE_DESC_BOB + FOLLOWUP_DESC_BOB
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + DATE_DESC_AMY + FOLLOWUP_DESC_AMY + NRIC_DESC_AMY
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + DATE_DESC_BOB + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DESCRIPTION_BOB,
                expectedMessage);

        // missing date prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_DATE_BOB + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DESCRIPTION_BOB,
                expectedMessage);

        // missing followUp prefix
        assertParseFailure(parser, NAME_DESC_BOB + DATE_DESC_BOB + VALID_FOLLOWUP_BOB + NRIC_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DESCRIPTION_BOB,
                expectedMessage);

        // missing ic prefix
        assertParseFailure(parser, NAME_DESC_BOB + DATE_DESC_BOB + FOLLOWUP_DESC_BOB + VALID_NRIC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DESCRIPTION_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_DESC_BOB + DATE_DESC_BOB + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_DATE_BOB + VALID_FOLLOWUP_BOB + VALID_NRIC_BOB
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + DATE_DESC_BOB + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DESCRIPTION_BOB
                + TAG_DESC_SEVERITY + TAG_DESC_CALLED, Name.MESSAGE_CONSTRAINTS);

        // invalid nric
        assertParseFailure(parser, NAME_DESC_BOB + DATE_DESC_BOB + FOLLOWUP_DESC_BOB + INVALID_NRIC_DESC
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DESCRIPTION_BOB
                + TAG_DESC_SEVERITY + TAG_DESC_CALLED, Nric.MESSAGE_NRIC_CONSTRAINTS);

        // invalid date
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_DATE_DESC + FOLLOWUP_DESC_BOB + NRIC_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DESCRIPTION_BOB
                + TAG_DESC_SEVERITY + TAG_DESC_CALLED, Date.MESSAGE_DATE_CONSTRAINTS);

        // invalid followUp
        assertParseFailure(parser, NAME_DESC_BOB + DATE_DESC_BOB + INVALID_FOLLOWUP_DESC + NRIC_DESC_BOB
                + PHONE_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB + DESCRIPTION_BOB
                + TAG_DESC_SEVERITY + TAG_DESC_CALLED, FollowUp.MESSAGE_FOLLOWUP_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + DATE_DESC_BOB + FOLLOWUP_DESC_BOB
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + DATE_DESC_BOB + FOLLOWUP_DESC_BOB
