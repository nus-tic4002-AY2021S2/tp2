...
public class CommandTestUtil {
    ...
    public static final String VALID_DATE_AMY = "01-02-2021";
    public static final String VALID_DATE_BOB = "11-02-2020";
    public static final String VALID_NRIC_AMY = "S1234567B";
    ...
    public static final String VALID_DESCRIPTION_AMY = "She was molested by a Senior Investigations Officer "
        + "at the Jurong Police Division Headquarters in the interview room around 9.00pm.";
    public static final String VALID_DESCRIPTION_BOB = "This man is a construction site manager who flew a drone over"
    ...
    public static final String TAG_DESC_CALLED = " " + PREFIX_TAG + VALID_TAG_CALLED;
    public static final String TAG_DESC_SEVERITY = " " + PREFIX_TAG + VALID_TAG_SEVERITY;
    ...
    public static final String INVALID_DESCRIPTION = " " + PREFIX_DESCRIPTION; // empty string invalid for description
