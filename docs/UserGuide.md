...
* `add n/Rachel Lee r/Designer p/91648917 e/rachel@f18tech.com.sg a/BLK 730 Woodlands Road #15-150 b/1988-01-02 j/2020-09-01 s/8000 t/Founder t/l33tCoder`
  ![result for 'add n/Rachel Lee…'](images/addRachelLeeResult.png)
...
Example of usage:
* `list`
  ![result for 'list'](images/listEmployeesResult.png)
...
* `edit 1 p/91821748 s/8000 t/Mentor t/l33tCoder`
  ![result for 'edit 1 p/91821748…'](images/editAlexYeohResult.png)
...
Examples of usage:
* `list` followed by `delete 7` deletes the 7th employee record shown in the list of all employee records.
  ![result for 'delete 7'](images/deleteRachelLeeResult.png)
* `find n/Rachel` followed by `delete 1` deletes the 1st employee record in the list generated by the `find` command.

### Soring employee records: `sort`
...
Example of usage:
* `clear`
  ![result for 'clear'](images/clearEmployeesResult.png)
